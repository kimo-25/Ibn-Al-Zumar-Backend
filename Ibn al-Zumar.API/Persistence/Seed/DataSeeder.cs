...
public static class DataSeeder
{
    ...
    public static class PermissionCodes
    {
        ...
        public const string CustomersManageDebt = "Customers.ManageDebt"; // «·‘ﬂﬂ
        ...
        public static readonly (string Code, string Name, string Module)[] All =
        {
            ...
            (CustomersManageDebt, "Manage Customer Debt («·‘ﬂﬂ)", "Customers"),
    ...
    {
        var requiredRoles = new[] { "Admin", "Cashier", "Owner", "Moderator" };
        ...
        var missing = requiredRoles
            ...
            .Select(r => new Role
            {
                ...
                Description = r switch
                {
                    ...
                    "Moderator" => "Moderate content and manage products",
                    _ => null
                }
            })
            .ToList();
    ...
    private static async Task SeedRolePermissionsAsync(ApplicationDbContext context, ILogger logger)
    {
        ...
        // Cashier: a sensible default subset for day-to-day POS work. This is just seed data ó
