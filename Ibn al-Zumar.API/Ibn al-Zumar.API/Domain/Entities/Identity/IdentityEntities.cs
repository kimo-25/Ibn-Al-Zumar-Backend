...
public class User : BaseEntity
{
    ...
    // --- خاصة بتفعيل البريد الإلكتروني عند إنشاء الحساب ---
    ...
    // --- تغيير البريد الإلكتروني عبر OTP ---
    [MaxLength(150)]
    ...
    // --- خاصة برقم الهاتف والتحقق عبر OTP (تفعيل لاحق اختياري) ---
    ...
    // --- خاصة بتسجيل الدخول عبر مزودين خارجيين مثل Google ---
    public bool HasPassword => !string.IsNullOrEmpty(PasswordHash);

    // --- الحضور والانصراف والرواتب (Voice Biometric Attendance) ---
    [Range(0, double.MaxValue, ErrorMessage = "أجر الساعة يجب أن يكون رقماً موجباً.")]
    public decimal HourlyRate { get; set; }

    /// <summary>
    /// البصمة الصوتية للموظف (Voice Embedding) مخزنة كـ JSON Array من الأرقام
    /// كما يتم استرجاعها من Hugging Face Inference API لموديل speechbrain/spkrec-ecapa-voxceleb.
    /// </summary>
